...
A block-level element always starts on a new line and stretches across the entire width of its parent container.
...
Inline elements do not start on a new line; they flow within the surrounding text and only occupy the space their content needs.
